...
export const appRoutes = [{path: 'home', component: homeComponent},{path: 'child', component: childpageComponent},{path: '', redirectTo: 'home', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
